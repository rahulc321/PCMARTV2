                ...
                <div class="row">
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="2nd User" value="{{$edit->second_user}}" name="second_user" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="controls">
                            <label>User Price</label>
                            <input type="text" class="form-control" placeholder="User Price" value="{{$edit->add_user_price}}" name="add_user_price" required="">
                        </div>
                      </div>
                  ...
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            <label>Tax</label>
                            <input type="text" value="{{$edit->tax}}" class="form-control" placeholder="Tax" name="tax" required="">
                        </div>
                      </div>
                  </div>
