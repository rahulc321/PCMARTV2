    ...
    <div class="col-xl-3 col-md-4 col-sm-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="text-muted mb-0 line-ellipsis">Valid Contract</p>
    ...
    <div class="col-xl-3 col-md-4 col-sm-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="text-muted mb-0 line-ellipsis">Valid Value</p>
          <h2 class="mb-0"><span class="agree4">{{$totalValue}}</span></h2>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-md-4 col-sm-6">
     ...
     ?>
          ...
          <p class="text-muted mb-0 line-ellipsis">Renew Contract  <span style="color:green"><?=date('F')?></span></p>
    ...
    <div class="col-xl-3 col-md-4 col-sm-6">
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="text-muted mb-0 line-ellipsis">Renew Value <span style="color:green"><?=date('F')?></span></p>
          <h2 class="mb-0"><span class="expire2">{{$renewValue}} <?php  echo str_replace('.00','',$valueTotal) ?></span></h2>
        </div>
      </div>
    </div>
    <?php 
