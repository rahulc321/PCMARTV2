...
<section class="users-edit">
  <div class="card">
              ...
              <div class="col-12 col-sm-12">
                      ...
                      <div class="form-group cstmFormCWd">
                        <div class="controls">
                            ...
                            <input type="text" style="width: 106% !important;padding: 0.0rem 0.1rem;" class="form-control" placeholder="Sno Number" name="sno_number[]" value="{{$fsubA['sno_number']}}" >
                        </div>
                      </div>
                      ...
                      <div class="form-group cstmFormC">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Activation" name="activation_code[]" value="{{$fsubA['activation_code']}}" >
                        </div>
                      </div>
                      ...
                      <div class="form-group cstmFormC">
                        <div class="controls">
                            <label>User</label>
                            <input type="text" style="width: 53% !important;padding: 0.0rem 0.1rem;" class="form-control" placeholder="User" name="sub_user[]" value="{{$fsubA['user']}}" maxlength="3">
                        </div>
                      </div>
                      <div class="form-group cstmFormC" style="margin-left: -38px;
    margin-right: 3px;
    width: 12%;">
                        <div class="controls" >
                            <label>Start</label>
                            <input type="text" class="form-control" placeholder="Start" name="start[]" value="{{$fsubA['start']}}" >
                        </div>
                      </div>
                      ...
                      <div class="form-group cstmFormC" style="margin-right: 3px;
    width: 102px;">
                        <div class="controls">
                            <label>Expire</label>
                            <input type="text" class="form-control" placeholder="Expire" name="expire[]" value="{{$fsubA['expire']}}" >
                        </div>
                      </div>
                      ...
                      <div class="form-group cstmFormC">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Location" name="location[]" value="{{$fsubA['location']}}" >
                        </div>
                      </div>
                      ...
                      <div class="form-group cstmFormC">
                        <div class="controls">
                            <label>Counter</label>
                            <input type="text" class="form-control" placeholder="Counter" name="counter[]" value="{{$fsubA['counter']}}" >
                        </div>
                      </div>
                      <div class="form-group cstmFormCWd">
                        <div class="controls">
                            <label>Remark</label>
                            <input type="text" class="form-control" placeholder="Remark" name="remark[]" value="{{$fsubA['remark']}}" >
                        </div>
                      </div>
                    </div>
            </div>
                    ...
                    <div class="row">
                      <div class="col-12 col-sm-12">
                              ...
                              <div class="form-group cstmFormCWd">
                                <div class="controls">
                                    <!--label>Sno Number</label-->
                                    <input type="text" class="form-control" placeholder="Sno Number" name="sno_number[]" style="width: 106% !important;padding: 0.0rem 0.1rem;" value="{{$singleB['sno_number']}}">
                                </div>
                              </div>
                              <div class="form-group cstmFormC">
                                <div class="controls">
                                    <!--label>Activation Code</label-->
                                    <input type="text"  class="form-control" placeholder="Activation" name="activation_code[]" value="{{$singleB['activation_code']}}" >
                                </div>
                              </div>
                              ...
                              <div class="form-group cstmFormC">
                                <div class="controls">
                                    <!--label>User</label-->
                                    <input type="text" style="width: 53% !important;padding: 0.0rem 0.1rem;" class="form-control" placeholder="User" name="sub_user[]" value="{{$singleB['user']}}" maxlength="3">
                                </div>
                              </div>
                              <div class="form-group cstmFormC" style="margin-left: -38px;
    margin-right: 3px;
    width: 12%;">
                                <div class="controls">
                                    <!--label>Start</label-->
                                    <input type="text" class="form-control" placeholder="Start" name="start[]" value="{{$singleB['start']}}">
                                </div>
                              </div>
    ...
    width: 102px;">
                                <div class="controls">
                                    <!--label>Expire</label-->
                                    <input type="text" class="form-control" placeholder="Expire" name="expire[]" value="{{$singleB['expire']}}">
                                </div>
                              </div>
                              ...
                              <div class="form-group cstmFormC">
                                <div class="controls">
                                    <!--label>Location</label-->
                                    <input type="text" class="form-control" placeholder="Location" name="location[]" value="{{$singleB['location']}}">
                                </div>
                              </div>
                              ...
                              <div class="form-group cstmFormC">
                                <div class="controls">
                                    <!--label>Counter</label-->
                                    <input type="text" class="form-control" placeholder="Counter" name="counter[]" value="{{$singleB['counter']}}">
                                </div>
                              </div>
                              <div class="form-group cstmFormCWd">
                                <div class="controls">
                                    <!--label>Remark</label-->
                                    <input type="text" class="form-control" placeholder="Remark" name="remark[]" value="{{$singleB['remark']}}">
                                </div>
                              </div>
              ...
              <div class="row">
                <div class="col-12 col-sm-12">
                        ...
                        <div class="form-group cstmFormCO">
                          <div class="controls">
                              <label>Name</label>
                              <input type="text" class="form-control" placeholder="Name" name="cname[]" value="{{$fsubAI['name']}}" >
                          </div>
                        </div>
                        <div class="form-group cstmFormCO" >
                          <div class="controls">
                              <label>Phone</label>
                              <input type="text"  class="form-control" style="width: 75%;" placeholder="Phone" name="cphone[]" value="{{$fsubAI['phone']}}" >
                          </div>
                        </div>

                        <div class="form-group cstmFormCO" style="margin-left: -46px;
    margin-right: 0px;
    width: 24%;">
                          <div class="controls">
                              <label>Email</label>
                              <input type="text" class="form-control" placeholder="Email" name="cemail[]" value="{{$fsubAI['email']}}" >
                          </div>
                        </div>
                        ...
                        <div class="form-group cstmFormCO">
                          <div class="controls">
                              ...
                              <input type="text" class="form-control" placeholder="Teamviewer Id" name="teamviewer_id[]" value="{{$fsubAI['teamviewer_id']}}" >
                          </div>
                        </div>
                  ...
                  <div class="singleNewHIn">
                    <div class="row">
                      <div class="col-12 col-sm-12">
                              ...
                              <div class="form-group cstmFormCO">
                                <div class="controls">
                                    <input type="text" class="form-control"  placeholder="Name" name="cname[]" value="{{$singleBI['name']}}" >
                                </div>
                              </div>
                              <div class="form-group cstmFormCO" >
                                <div class="controls">
                                    <input type="text" class="form-control" style="width: 75%;" placeholder="Phone" name="cphone[]" value="{{$singleBI['phone']}}">
                                </div>
                              </div>
    ...
    width: 24%;">
                                <div class="controls">
                                    <input type="text" class="form-control" placeholder="Email" name="cemail[]" value="{{$singleBI['email']}}">
                                </div>
                              </div>
                              <div class="form-group cstmFormCO">
                                <div class="controls">
                                    <input type="text" class="form-control" placeholder="Teamviewer Id" name="teamviewer_id[]" value="{{$singleBI['teamviewer_id']}}">
                                </div>
                              </div>
