    ...
    <div class="card-body">
      ...
      <ul class="nav nav-tabs mb-2" role="tablist">
        ...
        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab"
          ...
          <i class="bx bx-user mr-25"></i><span class="d-none d-sm-block">Edit Schedule</span>
        </a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content">
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form class="form-validate" action="{{url('/app/updateschedulesession/')}}/{{$edit->id}}" method="post">
                  ...
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Company Name" name="companyName" required="" value="{{($edit->companyName=='') ? $edit->customerName : $edit->companyName}}">
                      ...
                      <div class="form-group">
                        <div class="controls">
                           ...
                           @foreach($trainers as $trainer)
                             <option value="{{$trainer->id}}" <?php if($edit->trainerId==$trainer->id){ echo 'selected'; }   ?>>{{$trainer->name}}</option>
                      ...
                      <div class="form-group">
                        <div class="controls">
                            <label>Product</label>
                            <input type="text" class="form-control" placeholder="Product" name="Product"  value="{{$edit->product}}">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" name="datetimes"  class="form-control" id="datepicker" value="{{date('d-m-Y',strtotime($edit->date))}}" />
                        </div>
                      </div>
                  ...
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" name="startTime"  class="form-control" id="start" value="{{$edit->startTime}}" />
                        </div>
                      </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" name="endTime"  class="form-control" id="end" value="{{$edit->endTime}}"/>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        <div class="controls">
                            <label>Type</label>
                            <select class="form-control" name="trainerType">
                              <option value="1" <?php if($edit->trainerType==1){ echo 'selected'; } ?>>Training</option>
                              <option value="2" <?php if($edit->trainerType==2){ echo 'selected'; } ?>>Onsite</option>
                              <option value="3" <?php if($edit->trainerType==3){ echo 'selected'; } ?>>Demo</option>
                            </select>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        <div class="controls">
                            <label>Remark</label>
                            <textarea class="form-control" name="remark" placeholder="Remark">{{$edit->remark}}</textarea>
