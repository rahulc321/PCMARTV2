                    ...
                    <div class="ibox-content">
                        <?php
                         ...
                         <div class="">
                          ...
                          <?php $perm = Helper::checkPermission(); ?>
                           @if(in_array('Subscription_send',$perm))
        ...
        <div class="modal-body">
          ...
          @csrf
              ...
              <div class="form-group">
                ...
                <select class="form-control priceType" name="sendtype">
              ...
              <div class="form-group">
                <label>Price</label>
                <select class="form-control priceType" name="priceType">
                   
                  <option value="1" selected >Current Price</option>
                </select>
              </div>

              <div class="form-group">
                <label></label>
                <input type="checkbox" class="testmode" name="testmode" checked="" value="1"> Is Test ?
              </div>


              <div class="form-group">
                 <input type="hidden" class="btnclick" value="0" name="btnclick">
                <button type="submit" class="btn btn-info submit12"><i class="bx bx-mail-send"></i></button>
              </div>
 ...
 $(function () {
    ...
    $(document).ready(function(){
      ...
      $('#empTable').DataTable({
         ...
         ajax: {
            url: "{{url('/app/subsEmailMarketing2')}}",
            type: "get",
           // dataType: 'json',
           /* data: {
                filterParams: {
            ...
            d.priceType = $('.priceType option:selected').val();
            d.testmode = checked;
            d.email = $('.email').val();
            d.btnclick = $('.btnclick').val();
