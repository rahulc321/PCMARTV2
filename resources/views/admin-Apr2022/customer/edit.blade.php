            ...
            <tbody>
             ...
             ->first();
              ...
              <tr>
                ...
                <td><input type="checkbox"  class="expcheck" data="{{$key}}" {{$readd}} @if($custoinfo['exp_date_checkbox']==1) {{'checked'}} @endif>
                <input type="hidden" name="expcheck[]" class="expcheck_{{$key}}" value="{{$val}}">
                </td>
                <td><input type="text" style="width: 100px" name="exp_date[]" value="<?php echo $ex?>" {{$readd}}></td>
