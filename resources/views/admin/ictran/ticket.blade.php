    ...
    <div class="card-body">
      ...
      <div class="tab-content">
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form class="form-validate ff" action="{{url('/app/ticket/store')}}/{{$id}}" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                      <button type="button" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1 dd">Submit</button>
