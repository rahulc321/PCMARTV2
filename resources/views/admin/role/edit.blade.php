                ...
                <div class="row">
                  ...
                  style="width:100%;">
                    ...
                    <tr>
                      ...
                      <td><input type="checkbox" class="i-checks" id="dashboard" name="keyname[]" value="web_add" <?php if(in_array('web_add',$userKey)){ echo 'checked'; } ?>></td>
                      ...
                      <!-- web info delete -->
                      <td><input type="checkbox" class="i-checks" id="dashboard" name="keyname[]" value="web_delete" <?php if(in_array('web_delete',$userKey)){ echo 'checked'; } ?>></td>
                    ...
                    <tr>
                      ...
                      <th class="aaa">Category</th>

                      <td>

                        <input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="Category_show" <?php if(in_array('Category_show',$userKey)){ echo 'checked'; } ?>>

                      </td>

                      <td>

                        <input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="Category_add" <?php if(in_array('Category_add',$userKey)){ echo 'checked'; } ?>>

                      </td>

                      <td>

                        <input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="Category_edit" <?php if(in_array('Category_edit',$userKey)){ echo 'checked'; } ?>>

                      </td>

                      <td>

                        <input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="Category_delete" <?php if(in_array('Category_delete',$userKey)){ echo 'checked'; } ?>>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="checkbox" class="i-checks" id="dashboard" name="keyname[]" value="Support" <?php if(in_array('Support',$userKey)){ echo 'checked'; } ?>> &nbsp;Support 

                      <br>
                      <input type="checkbox" class="i-checks" id="dashboard" name="keyname[]" value="c_subscription" <?php if(in_array('c_subscription',$userKey)){ echo 'checked'; } ?>> Subscription
                      <br>
                      <input type="checkbox" class="i-checks" id="dashboard" name="keyname[]" value="other_info" <?php if(in_array('other_info',$userKey)){ echo 'checked'; } ?>> Other Info
                      </td>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td>
                        ...
                        <input type="checkbox" class="i-checks" id="schedule_show" name="keyname[]" value="schedule_add" <?php if(in_array('schedule_add',$userKey)){ echo 'checked'; } ?>>
                    ...
                    <!-- For past -->
                    <tr>
                      <th class="aaa">Past</th>
                      <td></td>
                      <td></td>

                      <td><input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="schedule_past_edit" <?php if(in_array('schedule_past_edit',$userKey)){ echo 'checked'; } ?>></td>

                      <td><input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="schedule_past_delete" <?php if(in_array('schedule_past_delete',$userKey)){ echo 'checked'; } ?>></td>
                    ...
                    <!-- For Future -->
                    <tr>
                      <th class="aaa">Future</th>
                      <td></td>
                      <td></td>

                      <td><input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="schedule_future_edit" <?php if(in_array('schedule_future_edit',$userKey)){ echo 'checked'; } ?>></td>

                      <td><input type="checkbox" class="i-checks" id="admin_user_list" name="keyname[]" value="schedule_future_delete" <?php if(in_array('schedule_future_delete',$userKey)){ echo 'checked'; } ?>></td>
