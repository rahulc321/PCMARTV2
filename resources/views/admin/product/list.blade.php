        ...
        <div class="table-responsive">
          <table id="users-list-datatable" class="table">
            ...
            <tbody>
               ...
               $catName= App\Models\ProductCat::where('type',1)->where('id',$value->cat)->first();
              ...
              <tr>
               ...
               <!--  <td>
                ...
                @if(in_array($module,Helper::checkPermission()) || Auth::user()->user_type==1)
                <a href="{{asset('app/settings/delete')}}/{{$value->id}}" onclick="return confirm('Are you sure you want to delete this?')"><i class="bx bx-trash-alt"></i></a>
                 @endif
