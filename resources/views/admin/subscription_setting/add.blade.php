    ...
    <div class="card-body">
      ...
      <div class="tab-content">
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form class="form-validate" action="{{url('/app/subscription/store')}}" method="post">
                ...
                <div class="row">
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="1st User" name="first_user" required="">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Add User" name="add_user" required="">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="controls">
                            <label>Product</label>
                            <textarea class="form-control" placeholder="Product" name="description" required=""></textarea>
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                        <div class="controls">
                            ...
                            <textarea class="form-control" placeholder="Description" name="description2" required=""></textarea>
                        </div>
                      </div>

                  <?php
                      $catName= App\Models\ProductCat::where('type',2)->get();
                       ?>
                      <div class="form-group">
                        <div class="controls">
