                ...
                <div class="row">
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            <label>Product</label>
                            <textarea class="form-control" placeholder="Product" name="description" required="">{{$edit->description}}</textarea>
                        </div>
                      </div>
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                        <div class="controls">
                            ...
                            <textarea class="form-control" placeholder="Description" name="description2" required="">{{$edit->description_second}}</textarea>
                        </div>
                      </div>
                    <?php
