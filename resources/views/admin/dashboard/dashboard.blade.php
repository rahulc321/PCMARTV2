    ...
    <div class="col-xl-4 col-md-6 col-12 dashboard-visit">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <form action="{{url('/dashboard')}}" method="post" id="form1">
          @csrf
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
     ...
     var options = {
       ...
       chartArea:{left:10,top:0,width:'1000%',height:'100%'},                  
   ...
   google.charts.load('current', {'packages':['corechart']});
      ...
      var data = google.visualization.arrayToDataTable([
       ['Task', 'Hours per Day'],
       ['> 2 hr ', <?=$twohgreatherChart?> ],
       ['> 1/2 hr', <?=$greater30MinutesGChart?>],
       ['< 1/2 hr', <?=$less30MinutesChart?>],
