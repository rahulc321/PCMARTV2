                  ...
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="2nd User" name="second_user" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="controls">
                            <label>User Price</label>
                            <input type="text" class="form-control" placeholder="User Price" name="add_user_price" required="">
                        </div>
                      </div>
