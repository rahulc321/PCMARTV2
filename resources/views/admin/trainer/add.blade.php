    ...
    <div class="card-body">
      ...
      <ul class="nav nav-tabs mb-2" role="tablist">
        ...
        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab"
          ...
          <i class="bx bx-user mr-25"></i><span class="d-none d-sm-block">Add Trainer</span>
        </a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content">
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form class="form-validate" action="{{url('/app/trainer/store')}}" method="post">
                  ...
                  <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Trainer Name" name="fname" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="controls">
