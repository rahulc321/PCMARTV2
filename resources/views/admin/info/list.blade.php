...
<section class="users-list-wrapper">
  ...
  <div class="users-list-table">
    <div class="card">
      ...
      <a class="btn btn-success" href="{{url('/app/addInfo')}}" style="float: right;">Add Info</a>
      @endif
      <br>
      <br>
      @if (count($errors) > 0)
          ...
          <table id="users-list-datatable" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php $module='web_delete'; ?>
                @if(in_array($module,Helper::checkPermission()))
                <a href="{{asset('app/deleteInfo')}}/{{$info->id}}" onclick="return confirm('Are you sure you want to delete this?')"><i class="bx bx-trash-alt"></i></a>
