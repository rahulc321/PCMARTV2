         ...
         "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                    ...
                    var id=  aData.id;
                        ...
                        if(aData.editDataC==1){
                          $('td:eq(5)', nRow).append("<a href='{{url('app/customer-subscription-edit')}}/"+id+"' style='float: left !important;'><i class='bx bx-edit-alt' ></i></a>");
                        }

                        if(aData.deleteDataC==1){
                          $('td:eq(5)', nRow).append("<a href='{{url('app/customer-subscription-delete')}}/"+id+"' class='confirmDelete' style='float: left !important;'><i class='bx bx-trash-alt' ></i></a>");
                        }
                }
      });
